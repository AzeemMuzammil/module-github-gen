...
public isolated client class Client {
    ...
    # + comment_id - The unique identifier of the comment.
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/issues/comments/[int comment_id]() returns http:Response|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/issues/comments/${getEncodedUri(comment_id)}`;
    ...
    # + repo - The name of the repository without the `.git` extension. The name is not case sensitive.
    # + return - Response 
    resource isolated function delete repos/[string owner]/[string repo]/labels/[string name]() returns http:Response|error {
        string resourcePath = string `/repos/${getEncodedUri(owner)}/${getEncodedUri(repo)}/labels/${getEncodedUri(name)}`;
        http:Response response = check self.clientEp-> delete(resourcePath);
        return response;
    }
